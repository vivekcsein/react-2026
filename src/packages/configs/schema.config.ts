import { z } from "zod";
import { allowedMailDomains } from "./domain.config";
...
export const fullnameRules = trimString()
  ...
  .max(32, schemaMessages.fullnameTooLong)
...
export const emailRules = z
  ...
  .max(32, schemaMessages.emailTooLong)
  .refine(
    (email) => {
...
export const termsAcceptedRules = z.boolean().refine((value) => value === true, {
...
export const usernameRules = trimString()
  ...
  .max(32, schemaMessages.usernameTooLong)
